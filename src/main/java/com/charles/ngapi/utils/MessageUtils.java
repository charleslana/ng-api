package com.charles.ngapi.utils;
...
public class MessageUtils {
    ...
    public static final String ACCOUNT_CHARACTER_EXISTS = "Personagem já existe na conta.";
    ...
    public static final String ACCOUNT_PASSWORD_INCORRECT = "Senha atual incorreta.";
    public static final String CHARACTER_NOT_FOUND = "Personagem não encontrado.";
}
